...
Route::group(['middleware' => ['locale', 'theme', 'currency']], function () {
    ...
    Route::prefix('customer')->group(function () {
         ...
         * Login routes.
         */
        Route::controller(SessionController::class)->prefix('login')->middleware(['guest'])->group(function () {
            Route::get('', 'show')->name('shop.customer.session.index');
            Route::post('', 'store')->name('shop.customer.session.store');
            Route::get('create', 'create')->name('shop.customer.session.create');
        });

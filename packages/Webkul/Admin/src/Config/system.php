...
return [
    ...
    [
        'key'    => 'sales.carriers.customflatrate',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.title-info',
        'sort'   => 2,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.title',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
            ...
            [
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.description',
                'type'          => 'textarea',
                'channel_based' => true,
                'locale_based'  => true,
            ],
            [
                'name'          => 'default_rate',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.rate',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
            ...
            [
                'name'    => 'type',
                'title'   => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.type.title',
                'type'    => 'select',
                'options' => [
                    [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.type.per-unit',
                        'value' => 'per_unit',
                    ],
                    [
                        'title' => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.type.per-order',
                        'value' => 'per_order',
                    ],
                ],
                'channel_based' => true,
            ...
            [
                'name'          => 'active',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.custom-flat-rate-shipping.status',
                'type'          => 'boolean',
                'channel_based' => true,
                'locale_based'  => false,
            ],

...
use App\Http\Controllers\Sales\CustomOrderController;
...
Route::group(['middleware' => ['admin'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('sales')->group(function () {
        ...
        Route::post('admin/sales/orders/comment/{id}', [CustomOrderController::class, 'comment'])->name('admin.sales.orders.comment');
